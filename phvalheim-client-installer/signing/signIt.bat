...
REM "%sdk%\MakeCert.exe" /n CN=posixone -a SHA256 /r /h 0 /eku "1.3.6.1.5.5.7.3.3,1.3.6.1.4.1.311.10.3.13" /e 01/01/2055 /sv ..\signing\MyKey.pvk ..\signing\MyKey.cer

REM convert the cert so we can sign code with it
REM "%sdk%\Pvk2Pfx.exe" -f /pvk "..\signing\MyKey.pvk" /spc "..\signing\MyKey.cer" /pfx "..\signing\MyKey.pfx"
