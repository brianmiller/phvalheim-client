...
$codeSignPfx = "\\REDACTED-BUILD-HOST\development\brian\phvalheim-client.pfx"
$codeSignPfxPw = Get-Content "\\REDACTED-BUILD-HOST\development\brian\phvalheim-client-pfx.pw" -Raw
