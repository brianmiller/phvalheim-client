...
namespace PhValheim.Steam
{
    public class PhValheim
    {
        ...
        public static bool ValheimGetter(string steamDir, ref string valheimDir)
        {
            ...
            foreach (var line in File.ReadAllLines(steamDir + slash+ "steamapps"+slash+"libraryfolders.vdf"))
            {
                ...
                {      
                    ...
                    {
                        bool valheimExists = File.Exists(libraryPath + slash+"steamapps"+slash+"appmanifest_892970.acf");
                        if (valheimExists)
                        {
                            valheimDir = libraryPath + slash+"steamapps"+slash+"common"+slash+"Valheim";
