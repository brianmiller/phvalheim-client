...
REM sign our msi
"%sdk%\signtool.exe" sign /f "..\signing\MyKey.pfx" /tr http://timestamp.comodoca.com/rfc3161 /td SHA256 /fd SHA256 /v "..\%buildType%\PhValheim Installer.msi"
...
REM "%sdk%\signtool.exe" sign /f "..\signing\MyKey.pfx" /tr http://timestamp.comodoca.com/rfc3161 /td SHA256 /fd SHA256 /v "..\%buildType%\phvalheim_installer.exe"
